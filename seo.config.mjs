 ...
 * index/works/about/contact .html, patches the case-study heads, and
...
export const SITE = {
  ...
  team: [
    ['Aayush', 'Founder · Product Design'],
    ['Kashish', 'Retail & Spatial Experience'],
    ['Alok', 'Interaction Design'],
    ['Jovi', 'Design & Business Strategy'],
    ['Himshikha', 'Creative & Art Direction'],
    ['Prashant', 'Industrial Design'],
    ['Naman', 'Backend Technology'],
    ['Anand', 'Marketing'],
    ['Sai', 'Operations & Finance']
  ]
};
...
export const ROUTES = [
  {
    ...
    description:
      'rabbitsfoot is an independent product design and UX studio in Bengaluru. Nine senior designers working on defence, healthcare, enterprise and autonomous-systems interfaces — no hand-offs in thinking.',
    priority: '1.0'
  },
  {
    key: 'works',
    file: 'works.html',
    path: '/works',
    title: 'Work — Defence, Healthcare & Enterprise Design Case Studies | rabbitsfoot',
    description:
  ...
  },
  {
    ...
    file: 'about.html',
    path: '/about',
    title: 'About — Nine Senior Designers in Bengaluru | rabbitsfoot',
    description:
      'rabbitsfoot is nine senior specialists spanning product, spatial, industrial, creative, technology and business design. The people you meet are the people who do the work.',
    priority: '0.8'
  },
  {
    key: 'contact',
